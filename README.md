...
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;">
  ...
  <div style="flex: 1; padding-right: 20px; max-width: 60%;">
    <p>My name is João, and I'm a Biomedical Sciences student and Neurophysiology researcher from Brazil who loves Machine Learning, AI, and tech! <style="flex: 0; max-width: 35%;">
